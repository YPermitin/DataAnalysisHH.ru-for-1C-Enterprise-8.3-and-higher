...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ПараметрТокенДоступа = СокрЛП(Настройки.ПараметрыДанных.Элементы.Найти("ТокенДоступа").Значение);
	Если ЗначениеЗаполнено(ПараметрТокенДоступа) Тогда
		ЭтотОбъект.ТокенДоступа = ПараметрТокенДоступа;
	КонецЕсли;
